...
object FinancialPlanner {
    ...
    fun calculate(input: PlannerInput): PlannerResult {
        ...
        val remainingVariableBudget = (input.variableMonthlyBudget - input.variableSpentThisMonth)
            .max(BigDecimal.ZERO)
        val emergencyTarget = input.essentialMonthlyExpenses
        ...
        val debtPayment = if (input.highCostDebtOutstanding > BigDecimal.ZERO) {
    ...
    private fun nextIncomeDate(asOf: LocalDate, payDay: Int): LocalDate =
